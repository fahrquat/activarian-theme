...
<h5><?php echo Kohana::lang('usermsg.send_author')?></h5>	
	<form action="<?php echo url::base(); ?>usermsg/send_msg_user" method="post" id="userMsg" name="userMsg" enctype="multipart/form-data">
	
	
		<input type="hidden" name="msg_username"  id="msg_username" value="<?php echo $username;?>">
