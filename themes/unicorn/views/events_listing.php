		...
		<div class="rb_list-and-map-box">
			...
			<?php
				...
				<div id="<?php echo $incident_id ?>" class="rb_report <?php echo $incident_verified_class; ?>">
					<div class="r_media">
						<p class="r_photo" style="text-align:center;"> <a href="<?php echo url::site(); ?>events/view/<?php echo $incident_id; ?>">
					...
					<div class="r_details">
						<h3><a class="r_title" href="<?php echo url::site(); ?>events/view/<?php echo $incident_id; ?>">
								<?php echo html::specialchars($incident_title); ?>
							</a>
							<a href="<?php echo url::site(); ?>events/view/<?php echo $incident_id; ?>#discussion" class="r_comments">
