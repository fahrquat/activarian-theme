...
class Resources_Controller extends Events_Controller {
	...
	public function index()
	{
		...
		$this->template->content = new View('resources');
		$this->themes->js = new View('resources_js');
		...
		$_GET['rec']=extrauserinfohelper::$guardian_role_id;
	...
	private function _get_report_listing_view($locale = '')
	{
		...
		$report_listing = new View('resources_listing');
